...
Although Newton probably discoverd his Calculus first, Leibniz published the first
...
We have precedent for this.  All of geometry depends on the notion of
...
The rules for differentiation are surprisingly easy to learn and
...
% Specifically, notice that we did not
% distinguish between finite and infinitesimal differences in the first
% three rules.  The distinction between finite and infinitely small
% differences comes across in the Product Rule (Rule \#4),
% $\d(xy)=x\d y+y\d x.$
...
% For now, we will justify these rules as Leibniz did by noticing that
% they provide correct results.  For example, consider the following
% circle.
...
\noindent{\bf{}Differentiation Rule \#5 (The Power Rule):}\\
...
% function. This makes perfect sense in simple cases.
...
Even more succinctly we have:\\[2mm]
